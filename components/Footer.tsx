		...
		<div className="bg-white">
			<div className="container py-4">
				<div className="d-flex flex-column justify-content-md-between flex-md-row">
					<div>
						<h5 className="text-center text-md-left">Shop</h5>
						<ul className="list-style-none">
							<li className="mb-1 text-center text-md-left">
							...
							<li className=" text-center text-md-left">
								<a href="#">Gift Vouchers</a>
							</li>
						</ul>
					</div>
					<div className="mt-4 mt-md-0">
						<h5 className="text-center text-md-left">Account</h5>
						<ul className="list-style-none">
							<li className="mb-1 text-center text-md-left">
								<a href="#">My Account</a>
							</li>
					...
					<div className="mt-4 mt-md-0">
						<h5 className="text-center text-md-left">Help</h5>
						<ul className="list-style-none">
							<li className="mb-1 text-center text-md-left">
								<a href="#">Help</a>
							</li>
					...
					<div className="mt-4 mt-md-0">
						<h5 className="text-center text-md-left">Company</h5>
						<ul className="list-style-none">
							<li className="mb-1 text-center text-md-left">
								<a href="#">About Us</a>
							</li>
					...
					<div className="social-icon-container mt-4 mt-md-0">
						...
						<ul className="list-style-none d-flex justify-content-center justify-content-md-between m-0 pl-0 overflow-hidden">
