 ...
 */						>
							<span className="material-icons mr-1 font-bold py-0.5 px-2 rounded">delete</span>
							<span>Remove</span>
						</button>
						...
						>
							...
							<span><Link href={`/products/${id}`}>Add to Cart </Link></span>
						</button>
						</div>
					</div>
			</div>
...
export default WhishlistProductItem;
