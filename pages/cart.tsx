		...
		<>
			...
			<section className="ppx-6 py-8 grid lg:gap-y-3 lg:grid-cols-5 lg:px-16 relative">
					...
					<div className="col-span-3">
						<h1 className="mb-6 ml-8 px6">Shopping Cart</h1>
						<div
							className={cn(
						...
						>
							...
							<aside className="fixed bottom-0 left-0 w-full h-auto bg-white  mt-4 ml-2 px-4 py-6 lg:relative lg:ml-5 lg:mt-0 lg:w-80">
								<h2>Cart Summary</h2>
